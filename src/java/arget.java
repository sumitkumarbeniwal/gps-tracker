 ...
 * @author Beniwal
 */
public class arget extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
         database db=new database();
              ...
              PreparedStatement ps = con.prepareStatement("select * from adminlogin where phone=?");
...
"\n" +
"<form   method=\"post\" action=\"adminupdate?flag=1\">\n" +
"    <table border='0'>\n" +
"\n" +
" <tr>\n" +
" <tr>\n" +
