...
public class adminremove extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       if(flag==1)
       {
           String username = request.getParameter("cnumber"); 
           
           System.out.print("user is "+username);
       adminrecord ar =new adminrecord();
       a=ar.delete(username);
       }
...
"               \n";
        ...
        output+="<h1>Admin Delete</h1>\n" +
"\n" +
"<form   method=\"post\" action=\"adminremove?flag=1\">\n" +
"    <table border='0'>\n" +
"\n" +
" <tr>\n" +
"\n" +
...
" <tr>\n" +
"\n" +
"     <td><input type=\"submit\"  value=\"Remove\"/></td><td><input type=\"reset\"/></td>\n" +
"\n" +
" </tr>\n" +
" <tr>\n" +
